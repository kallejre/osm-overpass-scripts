...
for taginfo in deprecated_taginfo_nodupe:
    if "taginfo.openstreetmap.org/embed/tag?" in taginfo:
        deprecated_taginfo_t.append(taginfo.replace(
            "//taginfo.openstreetmap.org/embed/tag?", "https://taginfo.openstreetmap.org/api/4/tag/stats?"))
    elif "taginfo.openstreetmap.org/embed/key?" in taginfo:
        deprecated_taginfo_k.append(taginfo.replace(
            "//taginfo.openstreetmap.org/embed/key?key=", "https://taginfo.openstreetmap.org/api/4/key/stats?key="))
